...
api_send(string json)
        ...
        {
            using (var usetr_ma = new user_ma(user_id, name_user))
            {
        ...
        {
            using (var master_data = new from_master(user_id, name_user, user_role))
            {
                this.Hide(); // Ẩn MainForm sau khi mở form quản lý dữ liệu
        ...
        {
            using (var trans = new tra_cuu_log(user_id))
            {
        ...
        {
            using (var his_master = new his_master(user_id))
            {
                this.Hide(); // Ẩn MainForm sau khi mở form quản lý dữ liệu
        ...
        {
            using (var info_his = new his_info_users(user_id))
            {
                this.Hide(); // Ẩn MainForm sau khi mở form quản lý dữ liệu
